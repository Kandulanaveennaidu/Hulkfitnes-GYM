      ...
      <div className="container grid shadow-2xl xl:grid-cols-2 ">
        <div className="flex h-full flex-col gap-4 self-center bg-white p-4">
          ...
          <p className="font-medium text-gray-300">
            In a small town, nestled between rolling hills and lush greenery,
            lived a community of people who cherished the simple joys of life.
            Children laughed and played in the sunlit streets, while elders
            shared stories under the shade of ancient trees. Each day brought
            new possibilities, and the town thrived with a sense of warmth and
            togetherness.
          </p>
        </div>
